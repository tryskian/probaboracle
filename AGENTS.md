...
If the change touches product shape, docs drift, or repo conventions, also scan [docs/governance/DECISIONS.md](./docs/governance/DECISIONS.md). If the change touches runtime or eval parameters, inspect [src/probaboracle/config.py](./src/probaboracle/config.py).
...
- Do not add a UI shell, backend API, auth, deployment scaffolding, or extra prompt input unless explicitly requested.
